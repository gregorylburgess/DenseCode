Decompressor of Dynamic  End-Tagged Dense Code (dletdc)

Permits to decompress a file compressed with detdc.
...
Notes: 
 ...
 - A file "timesDecDETDC.txt" is also created after decompression. It logs decompression times (useful to perform several runs of the decompressor and then collect all the time measures).
