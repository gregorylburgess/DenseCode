...
/*-----------------------------------------------------------------------
 ...
 /* Thanks to Edleno Silva de Moura for this module. I made some modifications to
 adapt it to my code.
*/
...
#define LINE_UP(x,numBytes) ((x>>(4-numBytes)*8))    //move "4-bytes" bytes to the right
	...
	#define LE_LONG32(x)  (((x&0xff000000)>>24)|((x&0x00ff0000)>>8)|((x&0x0000ff00)<<8)|((x&0x000000ff)<<24))
	 ...
	 void writeCodeWord(BufferWrite bw, unsigned int *number, unsigned int *numBytes) {
		unsigned int tmp;
